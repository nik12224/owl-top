...
import '../../scss/components/_course.scss'
				...
				<div className="header">
					...
					<div className="header__right">
						<div>
							...
							<span className="header__price--dop">цена</span>
						</div>
						<div>
							<p className="header__price">
								5 000 ₽<span className="header__price--month">/мес</span>
							</p>
							<span className="header__price--dop">в кредит</span>
						</div>
